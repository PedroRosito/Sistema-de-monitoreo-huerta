...
void eventLogUpdate()
{
    ...
    currentState = humidityBelowDetectorStateRead();
    eventLogElementStateUpdate( humLastState, currentState, "IRRIGATE" );
    humLastState = currentState;
