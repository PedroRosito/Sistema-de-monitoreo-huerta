...
static void commandEnterNewMinHumidityLevel();
...
static void pcSerialComCommandUpdate( char receivedChar )
{
    switch (receivedChar) {
        ...
        case '4': commandEnterNewMinHumidityLevel(); break;
        case '5': commandEnterCodeSequence(); break;
        case '6': commandEnterNewCode(); break;
...
static void availableCommands()
{
    ...
    uartUsb.printf( "Press '4' to enter new min humidity level\r\n" );
    uartUsb.printf( "Press '5' to enter the code to deactivate the alarm\r\n" );
    uartUsb.printf( "Press '6' to enter a new code to deactivate the alarm\r\n" );
    ...
    uartUsb.printf( "Press 'h' or 'H' to get humidity reading\r\n");
...
{
    float humidity;
    uartUsb.printf( "Please enter new min humidity level: " );
    uartUsb.scanf( "%f", &humidity );
    updateMinHumLevel( humidity );
    uartUsb.printf("%f\r\n", humidity);
}
